...
assert(!script.includes("setDetail('network'") && !html.includes('data-detail="network"') && !html.includes('id="returning-network"'), 'Network/provider information is exposed in the returning-visitor popup');
